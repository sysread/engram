...
Tools are available as: `engram_remember`, `engram_recall`, `engram_list`, `engram_show`, `engram_forget`, `engram_move`, `engram_find-duplicates`, `engram_list-stores`.
...
Include a confidence score (1-10) on observations about the user or your preferences:
